...
class WebsiteAd extends StatelessWidget {
        ...
        builder: (_context, constraints) => ResponsiveWrapper(
          ...
          child: Container(
            child: Flex(
              ...
              children: [
                constraints.maxWidth > 720 ? _buildDescription(constraints) : _buildPicture(constraints),
                constraints.maxWidth > 720 ? _buildPicture(constraints) : _buildDescription(constraints),
              ],
            ),
          ),
        ),
  ...
  Expanded _buildPicture(BoxConstraints constraints) {
    return Expanded(
  ...
  Expanded _buildDescription(BoxConstraints constraints) {
    return Expanded(
                flex: constraints.maxWidth > 720 ? 1 : 0,
                child: Column(
